...
//validate current password
   $ret=mysqli_query($con, "call sp_usercurrentpwdvalidate('$cpwd','$uid')");
...
<body id="page-top">
 ...
 <h1 class="h3 mb-0 text-gray-800"><?php echo ucwords($_SESSION['username']);?>'s Profile | Change Password</h1>
                    </div>
